  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-2xl px-6">
        ...
        <div className="relative overflow-hidden rounded-2xl border-2 border-meta-purple/20 bg-white p-8 shadow-xl shadow-meta-purple/5 md:p-10">
          {/* Decorative gradient */}
          <div
            className="pointer-events-none absolute -right-20 -top-20 size-40 rounded-full bg-meta-pink/10 blur-3xl"
            aria-hidden
          />
          <div
            className="pointer-events-none absolute -bottom-20 -left-20 size-40 rounded-full bg-meta-purple/10 blur-3xl"
            aria-hidden
          />
          ...
          >
            <div>
              ...
              >
                Full Name <span className="text-meta-pink">*</span>
              </label>
              <input
                type="text"
                id="fullName"
            ...
            <div>
              <label
                ...
                className="mb-2 block text-sm font-semibold text-meta-dark"
              >
                Email <span className="text-meta-pink">*</span>
              </label>
              <input
                type="email"
                id="email"
            ...
            <div>
              <label
                ...
                className="mb-2 block text-sm font-semibold text-meta-dark"
              >
                Main Account (URL) <span className="text-meta-pink">*</span>
              </label>
              <input
                type="url"
                id="mainAccountUrl"
                ...
                onChange={handleChange}
                required
                placeholder="https://instagram.com/yourhandle or TikTok/YouTube URL"
                className={inputClass}
              />
